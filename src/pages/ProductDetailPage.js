...
const ProductDetailPage = {
    ...
    async render() {
        ...
        return `
        <div class="max-w-7xl m-auto flex flex-wrap items-center justify-start">
             <div class="container mx-auto px-6">
                <div>
                    ...
                    <div class="md:flex md:items-center">
                        ...
                        <div class="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
                            ...
                            <div class="flex items-center mt-6">
                                ...
                                <button id="cart-button" class="mx-2 text-gray-600 border rounded-md p-2 hover:bg-blue-500 focus:outline-none">
                    ...
                    <div class="mt-6">
                        <p class="text-gray-600 text-xl font-medium">Description</p>
                        ${product.description}
                    </div>
                </div>
                <div class="mt-16">
